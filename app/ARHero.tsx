  ...
  return (
      <div className="relative w-full min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-center tracking-tight mb-5 leading-[1.1] px-4">
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/80 text-center max-w-xl mx-auto mb-12 font-light leading-relaxed">
              ...
              <span className="font-semibold text-white" style={{color: "hsl(var(--color-brand-accent))"}}>
              augmented reality
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <button
                  ...
                  style={{
                    ...
                    boxShadow: "0 10px 30px -10px hsl(var(--color-brand-accent) / 0.5)"
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = "0 15px 40px -10px hsl(var(--color-brand-accent) / 0.7)";
                    e.currentTarget.style.transform = "scale(1.05) translateY(-1px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = "0 10px 30px -10px hsl(var(--color-brand-accent) / 0.5)";
        ...
        >
          <div className="flex flex-col items-center gap-2 animate-bounce">
            <span className="text-white/70 text-sm font-light tracking-wide">Scroll to explore</span>
            <svg
                className="w-6 h-6"
                fill="none"
                strokeLinecap="round"
